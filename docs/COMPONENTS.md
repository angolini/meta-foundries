...
| [`docker-cli-config`](../recipes-support/docker-cli-config/docker-cli-config_0.1.bb) | — | Base system Docker CLI config naming the Hub credential helper for `FIO_HUB_URL` |
| [`docker-credential-helper-fio`](../recipes-support/docker-credential-helper-fio/docker-credential-helper-fio_0.1.bb) | — | Docker credential helper that fetches Hub registry credentials via `aktualizr-get` |
